...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Example of an add to cart functionality (Update your existing cart logic if necessary)
  const menuItems = document.querySelectorAll('.add-to-cart');
  menuItems.forEach(item => {
      item.addEventListener('click', () => {
          const itemName = item.parentElement.getAttribute('data-name');
          const itemPrice = parseFloat(item.parentElement.getAttribute('data-price'));
